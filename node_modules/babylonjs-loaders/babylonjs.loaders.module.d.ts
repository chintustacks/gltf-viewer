...
declare module "babylonjs-loaders/glTF/2.0/Extensions/KHR_animation_pointer.map" {
import { AnimationGroup } from "babylonjs/Animations/animationGroup";
...
import { Scene } from "babylonjs/scene";
import { IProperty } from "babylonjs-gltf2interface";
import { IGLTF, ISampler, INode, IScene, IMesh, IAccessor, ICamera, IAnimation, IBuffer, IBufferView, IMaterial, ITextureInfo, ITexture, IImage, IMeshPrimitive, IArrayItem as IArrItem } from "babylonjs-loaders/glTF/2.0/glTFLoaderInterfaces";
import { IGLTFLoaderExtension } from "babylonjs-loaders/glTF/2.0/glTFLoaderExtension";
import { IGLTFLoader, IGLTFLoaderData } from "babylonjs-loaders/glTF/glTFFileLoader";
...
export class GLTFLoader implements IGLTFLoader {
    /** @hidden */
    static readonly _KHRAnimationPointerName: string;
    /** @hidden */
...
declare module "babylonjs-loaders/glTF/2.0/glTFUtilities" {
 ...
 */
export function getDataAccessorElementCount(accessorType: AccessorType): 1 | 2 | 3 | 4 | 9 | 16;
...
declare module BABYLON.GLTF2.Loader.Extensions {
    ...
    export class KHR_animation_pointer implements BABYLON.GLTF2.IGLTFLoaderExtension {
         ...
         * @returns A void promise when the channel load is complete
         */
        _loadAnimationChannelAsync(context: string, animationContext: string, animation: BABYLON.GLTF2.Loader.IAnimation, channel: BABYLON.GLTF2.Loader.IAnimationChannel, animationTargetOverride?: Nullable<IAnimatable>): Promise<void>;
        private _loadAnimationSamplerAsync;
        /**
         * parsing animation pointer is the core of animation channel.
         * Animation pointer is a Json pointer, which mean it locate an item into the json hierarchy.
...
declare module BABYLON.GLTF2.Loader.Extensions {
        export type GetGltfNodeTargetFn = (source: BABYLON.GLTF2.Loader.IGLTF, indices: string) => any;
    type GetValueFn = (target: any, source: Float32Array, offset: number, scale?: number) => any;
    export interface IAnimationPointerPropertyInfos {
        type: number;
        name: string;
    ...
    export var CoreAnimationPointerMap: any;
...
declare module BABYLON.GLTF2 {
     ...
     * @returns the number of item to be gather at each keyframe
     */
    export function getDataAccessorElementCount(accessorType: BABYLON.GLTF2.AccessorType): 1 | 2 | 3 | 4 | 9 | 16;
